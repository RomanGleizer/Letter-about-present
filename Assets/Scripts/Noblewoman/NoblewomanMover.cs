...
public class NoblewomanMover : MonoBehaviour
{
    ...
    public void SaveNobleWomanData()
    {
        ...
        data.Target = _target;
        data.CurrentPoint = _currentPoint;

        data.IsPlayerMoveLeft = _animator.GetBool("IsMoveLeft");
        data.IsPlayerMoveRight = _animator.GetBool("IsMoveRight");
        data.IsPlayerMoveUp = _animator.GetBool("IsMoveUp");
        data.IsPlayerMoveDown = _animator.GetBool("IsMoveDown");
